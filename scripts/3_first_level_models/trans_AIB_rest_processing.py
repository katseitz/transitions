...
def main():
    ...
    indir = '/projects/b1108/studies/transitions2/data/processed/neuroimaging/ses-1_v23_2_0_nofmap/'
    outdir = '/projects/b1108/studies/transitions2/data/processed/neuroimaging/AIB_RestOnly_Networks/'
